    ...
    return (
      <div className=" xl:mx-auto ">
        <div className="flex flex-wrap">
          <div className="xl:flex xl:flex-no-wrap xl:m-auto sm:w-full md:w-full lg:w-full background1 sm:w-full md:w-full">
            <div className="flex flex-wrap">
          ...
          <div className="xl:flex sm:w-full md:w-full lg:w-full  xl:mt-56 justify-center sm:w-full md:w-full">
            <Video className="video"/>
          </div>
          <div className=" xl:flex sm:w-full md:w-full lg:w-full xl:flex-no-wrap background2 xl:my-56 lg:my-24">
            <div className="flex flex-wrap">
          ...
          <div className=" xl:flex sm:w-full md:w-full lg:w-full xl:flex-no-wrap xl:m-auto background3">
            <div className="flex flex-wrap">
              <div className="xl:flex xl:w-6/12  xl:my-56 sm:w-full md:w-full">
          ...
          <div className="xl:flex sm:w-full md:w-full lg:w-full xl:flex-no-wrap xl:m-auto xl:my-40">
            <div className="flex flex-wrap">
            <div className="xl:flex xl:flex-no-wrap xl:m-auto xl:w-6/12 xl:justify-center xl:ml-20 ml-32 sm:w-full md:w-full">
            ...
            <div className="mx-20 xl:mt-32 xl:w-4/12 sm:w-full md:w-full">
          ...
          <div className="xl:flex sm:w-full md:w-full lg:w-full xl:flex-no-wrap xl:m-auto background4">
            <div className="flex flex-wrap">
              <div className="xl:flex-none xl:w-6/12 xl:m-auto sm:w-full md:w-full">
              ...
              <div className="xl:flex-none xl:w-6/12 xl:mx-auto sm:w-full md:w-full">
